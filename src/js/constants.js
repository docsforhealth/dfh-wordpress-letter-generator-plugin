...
export const BLOCK_LETTER_DATA_ELEMENTS = `${NAMESPACE}/data-elements`;
export const BLOCK_DATA_LAYOUT_PREVIEW = `${NAMESPACE}/data-layout-preview`;
export const BLOCK_DATA_LAYOUT_SECTION = `${NAMESPACE}/data-layout-section`;
export const BLOCK_LETTER_CONTENT = `${NAMESPACE}/letter-content`;
export const BLOCK_LETTER_DATA_LAYOUT = `${NAMESPACE}/letter-data-layout`;
